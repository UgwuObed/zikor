...
class PaymentController extends Controller
{
    ...
    public function initializePayment(Request $request)
    {
        ...
        // Generate a signed callback URL to ensure security
    ...
    public function handlePaymentCallback(Request $request)
{
    ...
    // Find pending payment without requiring auth
    ...
    // Get user from pending payment (no auth needed)
    ...
    try {
        ...
        return redirect()->to($frontendUrl . '/plan/verify?payment=failed');
    }
}
